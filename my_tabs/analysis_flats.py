...
tab_1_layout = html.Div([
								dbc.Row([
									...
									dbc.Col(
										html.Div(
										    children=[dcc.Input(id='input-userEmail-flats')],  # fill out your Input however you need
										    style=dict(display='flex', justifyContent='center')
										)
									),
									dbc.Col(
										html.Div(id='output-userEmail-flats')
									),
									dcc.Store(id = 'output-userEmailStatus-flats', storage_type = 'memory')
							    ...
							    dbc.Row([
							        ...
							        dbc.Col(
							            dbc.Input(id='input-living_area-flats', type='number', 
							    ...
							    html.Br(),
							     dbc.Row([
							         ...
							         dbc.Col(html.P('Two/more spaces'),
							                    width={'size': 1, 'offset':0},
							                    ),
							        dbc.Col(html.P('Ocean View'),
							                    width={'size': 1, 'offset':0},
							                    ), 
							        dbc.Col(html.P('Housing Older Persons Act'),
							                    width={'size': 2, 'offset':0},
							                    ),
							        dbc.Col(html.P('Intercoastal View'),
							                    width={'size': 1, 'offset':0},
							                    ),
							        dbc.Col(html.P('Pets Allowed'),
							                    width={'size': 1, 'offset':0},
							                    ),
							         ], no_gutters=False
							        ),
							    dbc.Row([
							        ...
							        dbc.Col(dcc.Dropdown(
							            id='input-two_more_spaces-flats',
							            placeholder='Number',
							            options=[ 
							                {'label': 'Yes', 'value': 1},
							                {'label': 'No', 'value': 0}]),
							        ...
							        dbc.Col(dcc.Dropdown(
							            id='input-housing_older_person-flats',
							            placeholder='Select all that apply',
							            options=[ 
							                {'label': 'No Hopa', 'value': 1},
							                {'label': 'Unverified', 'value': 2},
							                {'label': 'Verified', 'value': 3}]),
							            width={'size':2,'offset':0}
							    ),
							        dbc.Col(dcc.Dropdown(
							            id='input-intercoastal_view-flats',
							            placeholder='Number',
							            options=[ 
							                {'label': 'Yes', 'value': 1},
							                {'label': 'No', 'value': 0}]),
							    ...
							    html.Br(),
							     dbc.Row([
							         dbc.Col(html.P('Style'),
							                    width={'size': 2, 'offset':1},
							                    ),
							         dbc.Col(html.P('Year Built'),
							                    width={'size': 1, 'offset':0},
							                    ),
							         dbc.Col(html.P('East of US ONE'),
							                    width={'size': 1, 'offset':0},
							                    ),
							         dbc.Col(html.P('Cornet Unit'),
							                    width={'size': 1, 'offset':0},
							                    ),
							        dbc.Col(html.P('Zip Code'),
							                    width={'size': 1, 'offset':0},
							                    ), 
							        dbc.Col(html.P('NLOYO'),
							                    width={'size': 1, 'offset':0},
							                    ),
							        dbc.Col(html.P('Assoc. Fee Paid'),
							                    width={'size': 1, 'offset':0},
							                    ),
							        dbc.Col(html.P('Ready to Lease'),
							                    width={'size': 1, 'offset':0},
							                    ),
							         ], no_gutters=False
							        ),
							    dbc.Row([
							        dbc.Col(dcc.Dropdown(
							            id='input-style-flats',
							            placeholder='Select all that apply',
							            options=[ 
							                {'label': 'C42-Condo 5 + Stories', 'value': 1},
							                {'label': 'T51-Townhouse Fee Simple', 'value': 2},
							                {'label': 'C41-Condo 1-4 Stories', 'value': 3},
							                {'label': 'T52-Townhouse Condo', 'value': 4},
							                {'label': 'V53-Villa Fee Simple', 'value': 5}]),
							            width={'size':2,'offset':1}
							    ),
							        dbc.Col(dcc.Dropdown(
							            id='input-year_built-flats',
							            placeholder='Year',
							            options=[
							        ...
							        dbc.Col(
							            dbc.Input(id='input-association_fee_paid-flats', type='number', 
							                      placeholder='From 0 to 15000', 
							                      min=0, max=15000, step=1, className='mb-3'),
							            width={'size':1, 'offset':0},
							            ),
							        dbc.Col(dcc.Dropdown(
							            id='input-ready_to_lease-flats',
							            placeholder='Number',
							            options=[ 
							                {'label': 'Yes', 'value': 1},
							                {'label': 'No', 'value': 0}]),
